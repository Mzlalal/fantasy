...
public class OauthControllerApi implements OauthFeignApi {
    ...
    @Autowired
    public OauthControllerApi(ClientService clientService, BCryptPasswordEncoder passwordEncoder, RedisTemplate<String, Object> redisTemplate) {
